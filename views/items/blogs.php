...
<div class="wr">
  <ul class="nav_span__add">
    ...
    <li><a href="#" class="active">Блоги</a></li>
  </ul>
</div>
...
<div class="wr">
  <div class="center">
    ...
    <aside class="categories">
      <span class="title--white">По авторам</span>
      ...
      <span class="title--white">Все блоги</span>
           
      <?= ListView::widget([
          'dataProvider' => $dataProvider,
          'itemView' => '_item_bloggers',
          'viewParams' => [
              'imagetype' => $imagetype,
              'imageurl'  => $imageurl,
          ],
          //'layout' => '<div class="fast_nav">{sorter}</div>{items}<div class="pages">{pager}</div>',
          'layout' => '<div class="fast_nav"></div>{items}<div class="pages">{pager}</div>',
          'sorter' => [
