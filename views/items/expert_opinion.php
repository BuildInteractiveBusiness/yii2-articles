...
<div class="wr">
  <ul class="nav_span__add">
    ...
    <li><a href="<?= Url::toRoute('/articles/items/expert-opinion') ?>" class="active">Мнение экспертов</a></li>
...
<div class="wr">
  <div class="center">
    ...
    <div class="back_links">
      ...
      <a href="<?= Url::toRoute('/articles/items/expert-opinion') ?>">Мнение экспертов</a>
    </div>
    <div class="clr"></div>
    ...
    <aside class="categories">
      ...
      <ul class="categories_list">
        ...
        <li <?php if(\Yii::$app->request->get('id') == $c->id) { echo 'class="active"'; } ?>>
            <?= Html::a($c->name, Url::toRoute(['/articles/items/expert-opinion-category','id' => $c->id])) ?>
        </li>
        <?php } ?>        
      </ul>
